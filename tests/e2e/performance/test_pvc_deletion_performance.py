...
class TestPVCDeletionPerformance(E2ETest):
    ...
    def test_multiple_pvc_deletion_measurement_performance(self, teardown_factory):
        ...
        start_time = helpers.measure_multiple_pvc_deletion_time(self.interface, pvc_objs, status="start")
        end_time = helpers.measure_multiple_pvc_deletion_time(self.interface, pvc_objs, status="end")
